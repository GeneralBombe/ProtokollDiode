...
\begin{figure}[H] % [H] forces the figure to be placed exactly where it appears in the text
	...
	\caption{Messchaltung zur bestimmung der Speicher- und Abfallzeit.}
	\vspace{1em}
\end{figure}
...
\[
C_{S0} = \SI{0}{\pico\farad} \quad \varepsilon_{\mathrm{r,Si}} = 11{,}7 \quad A_{RLZ} = \SI{2.5}{\milli\metre\squared}
\]
